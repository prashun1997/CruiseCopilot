...
# #
SERVO_HBRIDGE_2PIN = {
    "FWD_DUTY_PIN": "PCA9685.1:40.9",  # provides forward duty cycle to motor
    "BWD_DUTY_PIN": "PCA9685.1:40.8",  # provides reverse duty cycle to motor
    "PWM_STEERING_PIN": "PCA9685.1:40.1",       # provides servo pulse to steering servo
    "PWM_STEERING_SCALE": 1.0,        # used to compensate for PWM frequency differents from 60hz; NOT for adjusting steering range
    "PWM_STEERING_INVERTED": False,   # True if hardware requires an inverted PWM pulse
    "STEERING_LEFT_PWM": 530,         # pwm value for full left steering (use `donkey calibrate` to measure value for your car)
    "STEERING_RIGHT_PWM": 210        # pwm value for full right steering (use `donkey calibrate` to measure value for your car)
}
# 
# #
# # SERVO_HBRIDGE_3PIN
